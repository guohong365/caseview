...
public interface ModuleManager {
    ...
    public static interface ModuleAgent {
         ...
         * Creates the module.
         *
         * @param app The {@link com.uc.android.camera.app.AppController} which
         *            creates this module.
         * @param intent The {@link Intent} which starts the activity.
         * @return The module.
         */
     ...
     *
     * @param agent The {@link com.uc.android.camera.app.ModuleManager.ModuleAgent}
     *              of the module.
     * @throws NullPointerException if the {@code agent} is null.
     * @throws IllegalArgumentException if the module ID is
     ...
     * {@link com.uc.android.camera.app.ModuleManager.ModuleAgent} of all the
     * registered modules.
     */
    ...
    /**
     * Returns the {@link com.uc.android.camera.app.ModuleManager.ModuleAgent} by
     * the module ID.
     *
     * @param moduleId The module ID.
     * @return The agent.
