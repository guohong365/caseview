...
public class CompareItemActionsBar extends FrameLayout {
    ...
    public CompareItemActionsBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onFinishInflate() {
        ...
        mActionsBarButtons = findViewById(R.id.compare_item_options_buttons);
        mMainBar = mActiveBar = mActionsBarButtons;
    }
    ...
    public int getMainBar() {
        if (mMainBar == mActionsBarButtons) {
            return BAR_STANDARD;
        }
        return BAR_INVALID;
    }
    ...
    private void setupToggleButtonParams() {
        ...
        for (int i = 0; i < mActionsBarButtons.getChildCount(); i++) {
            View button = mActionsBarButtons.getChildAt(i);
