...
import com.uc.android.camera.widget.AnimationEffects;
import com.uc.android.camera.widget.SettingsCling;
...
public class ModeListView extends FrameLayout
    ...
    private abstract class ModeListState implements GestureDetector.OnGestureListener {
         ...
         * {@link ModeListState#shouldHandleTouchEvent(MotionEvent)}
         * returns {@code true}
         *
