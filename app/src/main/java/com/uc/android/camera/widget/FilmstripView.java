...
import com.uc.android.camera.data.FilmstripItem.VideoClickedCallback;
import com.uc.android.camera.debug.Log;
import com.uc.android.camera.filmstrip.FilmstripController;
import com.uc.android.camera.filmstrip.FilmstripDataAdapter;
import com.uc.android.camera.ui.FilmstripGestureRecognizer;
import com.uc.android.camera.ui.ZoomView;
...
public class FilmstripView extends ViewGroup {
    ...
    private static class ViewItem {
         ...
         *            {@link com.uc.android.camera.filmstrip.FilmstripDataAdapter}.
        ...
        /** Forwarding of {@link View#setAlpha(float)}. */
        ...
        /** Forwarding of {@link View#getAlpha()}. */
        public float getAlpha() {
            return mView.getAlpha();
        }

        /** Forwarding of {@link View#getMeasuredWidth()}. */
         ...
         * not set directly by {@link View#setTranslationX(float)}
        ...
        /**
         * Forwarding of {@link View#getHitRect(Rect)}.
         */
        ...
        /** Forwarding of {@link View#getVisibility()}. */
        public int getVisibility() {
            return mView.getVisibility();
        }

        /** Forwarding of {@link View#setVisibility(int)}. */
        ...
        /**
         * Forwarding of {@link View#measure(int, int)}.
         */
