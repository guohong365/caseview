...
/**
 * Simple size class until we are 'L' only and can use android.com.util.Size.
 */
public class Size {
    ...
    public Size(com.uc.android.ex.camera2.portability.Size size) {
    ...
    public com.uc.android.ex.camera2.portability.Size toPortabilitySize() {
        return new com.uc.android.ex.camera2.portability.Size(width, height);
    }
    ...
    public static List<Size> convert(List<com.uc.android.ex.camera2.portability.Size> sizes) {
        ArrayList<Size> converted = new ArrayList<>(sizes.size());
        for (com.uc.android.ex.camera2.portability.Size size : sizes) {
