...
package com.uc.android.camera.one.v2.sharedimagereader.ringbuffer;

import com.uc.android.camera.async.BufferQueue;
import com.uc.android.camera.async.BufferQueueController;
import com.uc.android.camera.async.ConcurrentState;
import com.uc.android.camera.async.CountableBufferQueue;
import com.uc.android.camera.async.Observable;
import com.uc.android.camera.one.v2.camera2proxy.ImageProxy;
import com.uc.android.camera.one.v2.sharedimagereader.ticketpool.Ticket;
...
import com.uc.android.camera.one.v2.sharedimagereader.util.TicketImageProxy;
