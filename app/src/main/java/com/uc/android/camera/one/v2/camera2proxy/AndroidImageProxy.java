...
package com.uc.android.camera.one.v2.camera2proxy;
...
/**
 * An {@link ImageProxy} backed by an {@link Image}.
 */
@ThreadSafe
public class AndroidImageProxy implements ImageProxy {
    ...
    public class Plane implements ImageProxy.Plane {
        ...
        /**
         * @see {@link Image.Plane#getRowStride}
         */
        @Override
        ...
        /**
         * @see {@link Image.Plane#getPixelStride}
         */
        @Override
        ...
        /**
         * @see {@link Image.Plane#getBuffer}
         */
        @Override
    ...
    /**
     * {@link Image} is not thread-safe, so all interactions must
