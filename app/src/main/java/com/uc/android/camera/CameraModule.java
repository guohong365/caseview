...
public abstract class CameraModule implements ModuleController {
     ...
     * This calls {@link
     * com.uc.android.camera.app.CameraProvider#requestCamera(int)}. The camera
     * will be returned through {@link
     * #onCameraAvailable(com.uc.android.ex.camera2.portability.CameraAgent.CameraProxy)}
     ...
     * This calls {@link
     * com.uc.android.camera.app.CameraProvider#releaseCamera(int)}.
