...
/**
 * The {@link com.uc.android.camera.one.OneCameraOpener} implementation on top of the Camera API 1.
 */
public class LegacyOneCameraOpenerImpl implements OneCameraOpener {
    ...
    /**
     * Instantiates a new {@link com.uc.android.camera.one.OneCameraOpener} for Camera1 API.
     */
